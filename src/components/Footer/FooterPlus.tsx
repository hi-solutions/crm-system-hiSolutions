...
export default function FooterPlus() {
  ...
  return (
    ...
    <div>
          ...
          <div className="grid grid-cols-1  md:grid-cols-5 gap-8 place-items-start    ">
            ...
            <div className="space-y-4 md:col-span-1  w-full">
              ...
              <form className="flex items-stretch max-w-sm gap-2 ">
                ...
                <Button
                  type="button"
                  className="!bg-white !text-blue-700 px-4 py-2 rounded-xl md:font-medium hover:!bg-blue-50 w-full"
                  onClick={() => openModal()}
                >
      ...
      <div className=" -t -white/20 text-[#016CA4] text-sm flex flex-col md:flex-row items-center justify-between gap-3 px-4 md:px-6 lg:px-20 py-6">
        <span>
